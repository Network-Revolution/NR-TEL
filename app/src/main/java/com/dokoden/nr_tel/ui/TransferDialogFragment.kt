...
import com.dokoden.nr_tel.databinding.TransferDialogFragmentBinding
...
class TransferDialogFragment : DialogFragment() {
    ...
    override fun onCreateView(inflater: LayoutInflater, container: ViewGroup?, savedInstanceState: Bundle?): View {
        val pagesSize = 4
        mainViewModel.isOnCalling.postValue(true)
        mainViewModel.callNumber.postValue("")

        TransferDialogFragmentBinding.inflate(inflater, container, false).also {
    ...
    override fun onCancel(dialog: DialogInterface) {
        ...
        mainViewModel.isOnCalling.postValue(false)
        mainViewModel.callNumber.postValue("")
    }
}
