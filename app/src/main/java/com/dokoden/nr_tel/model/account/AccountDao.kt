...
package com.dokoden.nr_tel.model.account
...
interface AccountDao {
    ...
    @Query("SELECT * FROM AccountData WHERE isDefault = 1 AND accountActive = 1 ORDER BY orderNumber ASC LIMIT 1")
    ...
    @Query("UPDATE AccountData SET isDefault = 0")
    fun clearDefault()

    @Query("UPDATE AccountData SET isDefault = 1 WHERE orderNumber = :id")
