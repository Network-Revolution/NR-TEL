...
import com.dokoden.nr_tel.model.account.AccountDatabase
import com.dokoden.nr_tel.model.account.AccountRepository
...
class AccountViewModel(application: Application) : AndroidViewModel(application) {
    ...
    fun updateOutgoing(orderNum: Int) {
        viewModelScope.launch(Dispatchers.IO) {
            ...
            repository.setDefault(orderNum)
        }
    }
    ...
    fun onItemSelectedNumber(parent: AdapterView<*>, view: View, position: Int, id: Long) {
        serverTransport = transportList[position]
    }
}
